...
class ImmoScout24Spider(scrapy.Spider):
	...
	root_url = "http://www.immobilienscout24.de/wohnen/berlin,berlin,{}-{}/mietwohnungen".format(areas, areas) 
	start_urls = [root_url +".html",
		       
	]	+ [ root_url + ",seite-%s.html"  % page for page in xrange(2,20) ]  
